...
- 🔌 **Multiple Backends**: Gemini, Anthropic Claude, HuggingFace, Groq, Ollama (OpenAI planned)
...
- **botticelli_models** - LLM provider implementations (feature-gated)
  ...
  - `groq` - Groq AI LPU inference (ultra-fast, 300+ tok/s)
...
- **[Groq Setup](GROQ.md)** - Groq AI LPU Inference API integration
