...
fn test_should_auto_summarize_large_text() -> anyhow::Result<()> {
    ...
    tracing::debug!(should_summarize, "Checked if large text should auto-summarize");
...
fn test_should_auto_summarize_small_text() -> anyhow::Result<()> {
    ...
    tracing::debug!(should_summarize, "Checked if small text should auto-summarize");
...
fn test_apply_retention_full_keeps_input() -> anyhow::Result<()> {
    ...
    let result = HistoryRetention::apply_retention(&inputs);
    tracing::debug!(input_count = inputs.len(), result_count = result.len(), "Applied retention policy 'Full'");
...
fn test_apply_retention_summary_replaces_large_input() -> anyhow::Result<()> {
    ...
    let result = HistoryRetention::apply_retention(&inputs);
    tracing::debug!(result_count = result.len(), "Applied retention policy 'Summary'");
...
fn test_apply_retention_drop_removes_input() -> anyhow::Result<()> {
    ...
    let result = HistoryRetention::apply_retention(&inputs);
    tracing::debug!(input_count = inputs.len(), result_count = result.len(), "Applied retention policy 'Drop'");
...
fn test_apply_retention_mixed_policies() -> anyhow::Result<()> {
    ...
    tracing::debug!(result_count = result.len(), "Applied mixed retention policies");
...
fn test_apply_retention_auto_summarize_large_full_input() -> anyhow::Result<()> {
    ...
    let result = HistoryRetention::apply_retention(&inputs);
    tracing::debug!(result_count = result.len(), "Applied retention with auto-summarize");
...
fn test_with_history_retention_modifies_table() -> anyhow::Result<()> {
    ...
    assert_eq!(modified.history_retention(), HistoryRetentionPolicy::Summary);
