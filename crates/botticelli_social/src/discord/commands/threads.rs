...
impl Threads {
    ...
    pub async fn list(
        ...
        let threads = http.get_guild_active_threads(guild_id).await.map_err(|e| {
    ...
    pub async fn delete(
        ...
        http.delete_channel(thread_id, None).await.map_err(|e| {
    ...
    pub async fn join(
        ...
        http.join_thread_channel(thread_id).await.map_err(|e| {
    ...
    pub async fn leave(
        ...
        http.leave_thread_channel(thread_id).await.map_err(|e| {
