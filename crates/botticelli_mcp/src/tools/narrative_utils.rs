...
/// Helper type providing narrative utility functions.
///
/// Groups related narrative operations under a single namespace for cleaner imports.
pub struct NarrativeHelper;
...
impl NarrativeHelper {
    ...
    pub fn extract_acts_from_description(description: &str) -> Vec<Act> {
        ...
        for (i, part) in parts.iter().enumerate() {
            let name = Self::extract_act_name(part, i);
            acts.push(Act {
                name,
