    ...
    pub async fn execute(&self, name: &str, input: Value) -> McpResult<Value> {
        ...
        match name {
            ...
            "echo" => {
                ...
                let result = self
                    .server
                    .echo(rmcp::handler::server::wrapper::Parameters(
            ...
            "create_narrative" => {
                ...
                let result = self
                    .server
                    .create_narrative(rmcp::handler::server::wrapper::Parameters(
                        serde_json::from_value(input)?,
                    ))
                    .await?;
                Ok(serde_json::to_value(result.0).unwrap())
            ...
            "modify_narrative" => {
                ...
                let result = self
                    .server
                    .modify_narrative(rmcp::handler::server::wrapper::Parameters(
                        serde_json::from_value(input)?,
                    ))
                    .await?;
                Ok(serde_json::to_value(result.0).unwrap())
            ...
            "save_narrative" => {
                ...
                let result = self
                    .server
                    .save_narrative(rmcp::handler::server::wrapper::Parameters(
                        serde_json::from_value(input)?,
                    ))
                    .await?;
                Ok(serde_json::to_value(result.0).unwrap())
            ...
            "validate_narrative" => {
                ...
                let result = self
                    .server
                    .validate_narrative(rmcp::handler::server::wrapper::Parameters(
                        serde_json::from_value(input)?,
                    ))
                    .await?;
                Ok(serde_json::to_value(result.0).unwrap())
            ...
            "execute_act" => {
                ...
                let result = self
                    .server
                    .execute_act(rmcp::handler::server::wrapper::Parameters(
                        serde_json::from_value(input)?,
                    ))
                    .await?;
                Ok(serde_json::to_value(result.0).unwrap())
            ...
            "execute_narrative" => {
                ...
                let result = self
                    .server
                    .execute_narrative(rmcp::handler::server::wrapper::Parameters(
                        serde_json::from_value(input)?,
                    ))
                    .await?;
                Ok(serde_json::to_value(result.0).unwrap())
            ...
            "generate" => {
                ...
                let result = self
                    .server
                    .generate(rmcp::handler::server::wrapper::Parameters(
                        serde_json::from_value(input)?,
                    ))
                    .await?;
                Ok(serde_json::to_value(result.0).unwrap())
            ...
            "create_narrative_session" => {
                ...
                let result = self
                    .server
                    .create_narrative_session(rmcp::handler::server::wrapper::Parameters(
                        serde_json::from_value(input)?,
                    ))
                    .await?;
                Ok(serde_json::to_value(result.0).unwrap())
            ...
            "elicit_metadata" => {
                ...
                let result = self
                    .server
                    .elicit_metadata(rmcp::handler::server::wrapper::Parameters(
                        serde_json::from_value(input)?,
                    ))
                    .await?;
                Ok(serde_json::to_value(result.0).unwrap())
            ...
            "elicit_act" => {
                ...
                let result = self
                    .server
                    .elicit_act(rmcp::handler::server::wrapper::Parameters(
                        serde_json::from_value(input)?,
                    ))
                    .await?;
                Ok(serde_json::to_value(result.0).unwrap())
            ...
            "finalize_narrative" => {
                ...
                let result = self
                    .server
                    .finalize_narrative(rmcp::handler::server::wrapper::Parameters(
                        serde_json::from_value(input)?,
                    ))
                    .await?;
                Ok(serde_json::to_value(result.0).unwrap())
            ...
            "elicit_carousel" => {
                ...
                let result = self
                    .server
                    .elicit_carousel(rmcp::handler::server::wrapper::Parameters(
                        serde_json::from_value(input)?,
                    ))
                    .await?;
                Ok(serde_json::to_value(result.0).unwrap())
            ...
            "get_narrative_state" => {
                ...
                let result = self
                    .server
                    .get_narrative_state(rmcp::handler::server::wrapper::Parameters(
                        serde_json::from_value(input)?,
                    ))
                    .await?;
                Ok(serde_json::to_value(result.0).unwrap())
            ...
            "validate_narrative_session" => {
                ...
                let result = self
                    .server
                    .validate_narrative_session(rmcp::handler::server::wrapper::Parameters(
                        serde_json::from_value(input)?,
                    ))
                    .await?;
                Ok(serde_json::to_value(result.0).unwrap())
            ...
            "apply_validation_fixes" => {
                ...
                let result = self
                    .server
                    .apply_validation_fixes(rmcp::handler::server::wrapper::Parameters(
                        serde_json::from_value(input)?,
                    ))
                    .await?;
                Ok(serde_json::to_value(result.0).unwrap())
            ...
            "elicit_text" => {
                ...
                let result = self
                    .server
                    .elicit_text(rmcp::handler::server::wrapper::Parameters(
                        serde_json::from_value(input)?,
                    ))
                    .await?;
                Ok(serde_json::to_value(result.0).unwrap())
            ...
            "elicit_bool" => {
                ...
                let result = self
                    .server
                    .elicit_bool(rmcp::handler::server::wrapper::Parameters(
                        serde_json::from_value(input)?,
                    ))
                    .await?;
                Ok(serde_json::to_value(result.0).unwrap())
            ...
            "elicit_number" => {
                ...
                let result = self
                    .server
                    .elicit_number(rmcp::handler::server::wrapper::Parameters(
                        serde_json::from_value(input)?,
                    ))
                    .await?;
                Ok(serde_json::to_value(result.0).unwrap())
            ...
            "elicit_select" => {
                ...
                let result = self
                    .server
                    .elicit_select(rmcp::handler::server::wrapper::Parameters(
                        serde_json::from_value(input)?,
                    ))
                    .await?;
                Ok(serde_json::to_value(result.0).unwrap())
            ...
            "create_scene" => {
                ...
                let result = self
                    .server
                    .create_scene(rmcp::handler::server::wrapper::Parameters(
                        serde_json::from_value(input)?,
                    ))
                    .await?;
                Ok(serde_json::to_value(result.0).unwrap())
            ...
            "list_scenes" => {
                ...
                let result = self
                    .server
                    .list_scenes(rmcp::handler::server::wrapper::Parameters(
                        serde_json::from_value(input)?,
                    ))
                    .await?;
                Ok(serde_json::to_value(result.0).unwrap())
            ...
            "update_scene" => {
                ...
                let result = self
                    .server
                    .update_scene(rmcp::handler::server::wrapper::Parameters(
                        serde_json::from_value(input)?,
                    ))
                    .await?;
                Ok(serde_json::to_value(result.0).unwrap())
            ...
            "delete_scene" => {
                ...
                let result = self
                    .server
                    .delete_scene(rmcp::handler::server::wrapper::Parameters(
                        serde_json::from_value(input)?,
                    ))
                    .await?;
                Ok(serde_json::to_value(result.0).unwrap())
            ...
            "discord_post_message" => {
                ...
                let result = self
                    .server
                    .discord_post_message(rmcp::handler::server::wrapper::Parameters(
                        serde_json::from_value(input)?,
                    ))
                    .await?;
                Ok(serde_json::to_value(result.0).unwrap())
            ...
            "discord_get_messages" => {
                ...
                let result = self
                    .server
                    .discord_get_messages(rmcp::handler::server::wrapper::Parameters(
                        serde_json::from_value(input)?,
                    ))
                    .await?;
                Ok(serde_json::to_value(result.0).unwrap())
            ...
            "discord_get_guild_info" => {
                ...
                let result = self
                    .server
                    .discord_get_guild_info(rmcp::handler::server::wrapper::Parameters(
                        serde_json::from_value(input)?,
                    ))
                    .await?;
                Ok(serde_json::to_value(result.0).unwrap())
            ...
            "discord_get_channels" => {
                ...
                let result = self
                    .server
                    .discord_get_channels(rmcp::handler::server::wrapper::Parameters(
                        serde_json::from_value(input)?,
                    ))
                    .await?;
                Ok(serde_json::to_value(result.0).unwrap())
            ...
            "query_content" => {
                ...
                let result = self
                    .server
                    .query_content(rmcp::handler::server::wrapper::Parameters(
                        serde_json::from_value(input)?,
                    ))
                    .await?;
                Ok(serde_json::to_value(result.0).unwrap())
            ...
            "export_metrics" => {
                ...
                let result = self
                    .server
                    .export_metrics(rmcp::handler::server::wrapper::Parameters(
                        serde_json::from_value(input)?,
                    ))
                    .await?;
                Ok(serde_json::to_value(result.0).unwrap())
