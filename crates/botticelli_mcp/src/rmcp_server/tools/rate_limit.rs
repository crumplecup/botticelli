...
#[tool]
#[instrument]
pub fn tier_rpm(params: TierRpmParams) -> TierRpmResult {
...
#[tool]
#[instrument]
pub fn tier_tpm(params: TierTpmParams) -> TierTpmResult {
...
#[tool]
#[instrument]
pub fn tier_rpd(params: TierRpdParams) -> TierRpdResult {
...
#[tool]
#[instrument]
pub fn tier_tpd(params: TierTpdParams) -> TierTpdResult {
...
#[tool]
#[instrument]
pub fn tier_max_concurrent(params: TierMaxConcurrentParams) -> TierMaxConcurrentResult {
...
#[tool]
#[instrument]
pub fn tier_daily_quota_usd(params: TierDailyQuotaParams) -> TierDailyQuotaResult {
...
#[tool]
#[instrument]
pub fn tier_cost_per_million_input_tokens(params: TierInputCostParams) -> TierInputCostResult {
...
#[tool]
#[instrument]
pub fn tier_cost_per_million_output_tokens(params: TierOutputCostParams) -> TierOutputCostResult {
...
#[tool]
#[instrument]
pub fn tier_name(params: TierNameParams) -> TierNameResult {
